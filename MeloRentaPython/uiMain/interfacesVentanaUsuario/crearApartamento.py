...
def crearApartamento():
    ...
    Apartamento(identificador,direccion,valor,tamano)
...
label1 = Label(master=frame1,text="Crear apartamento", borderwidth=1, relief="solid")
label2 = Label(master=frame1, text="Se piden por consola los parámetros necesarios para \nla creación del apartamento y luego se hace el guardado y notificación de éxito de la operación", borderwidth=1, relief="solid")
...
botonAceptar = Button(master=frame3, text="Aceptar",command=crearApartamento)
